...
<div class="background-materi" style=" background-image: linear-gradient(0deg, rgba(9,27,52,1) 0%, rgba(74,37,103,0) 100%), url(Asset/ki\ hajar.jpg);">
    <h1 class="header judul" id="page-title">BAB1</h1>
    <h1 class="judul header">FILOSOFI PENDIDIKAN DI INDONESIA</h1>
</div>
<div class="container-fluid">
    <div class="white m-t mb-5">
        <div class="m-l m-r">
            <h1 class="judul-materi text-center" >FILOSOFI</h1>
            <img src="Asset/kiii ha.webp" class="mt-5 img-materi" alt="">
            <p class="sumber img-materi">Ki Hajar Dewantara. (Istimewa)</p>
            <p class="text-white">Ki Hajar Dewantara sebagai Bapak Pendidikan Indonesia mencetuskan filosofi pendidikan yang dikenal lewat semboyan "Ing Ngarsa Sung Tuladha, Ing Madya Mangun Karsa, Tut Wuri Handayani" yang berarti di depan memberikan contoh atau sebagai panutan, di tengah membangun kemauan atau niat, dan di belakang memberikan dorongan atau semangat. <br><br> Filosofi pendidikan Ki Hajar Dewantara menunjukkan bahwa pendidikan di Indonesia, termasuk pendidikan tinggi, sudah semestinya dibangun atas semangat kolaborasi untuk saling mendukung dan menghargai agar semua pelajar dan mahasiswa dapat menikmati pendidikan yang sehat secara mental dan fisik, serta aman dan nyaman.</p>
        </div>
    </div>
 </div>
